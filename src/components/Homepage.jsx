    ...
    const calc = () => {
        if (inp <=0) {
            ...
            if (inp.length == 0 || fromSelect == '' || fromSelect == 'null' || toSelect == '' || toSelect == 'null') {
             ...
             x = props.coins.find((val) => { return val.coinValue == fromSelect })
             y = props.coins.find((val) => { return val.coinValue == toSelect })
        }
        props.addToArr(x,y,inp,total)
    }
    ...
    const view = () => {
        if (viewFlag === true) {
            if (props.arr.length == 0) {
                ...
                return <Viewexchanges arr={props.arr} setArr={props.setArr} />
            }
        }
    }
